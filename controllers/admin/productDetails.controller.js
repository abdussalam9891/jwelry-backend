...
*/
    ...
    orders.forEach((order) => {
      order.items.forEach((item) => {
        if (item.product.toString() === id) {
          ...
          const key = item.variant?.sku || "default";
      ...
      */
          ...
          variantMap[key].revenue += item.price * item.quantity;
        }
      });
    });
    ...
    const lowStockVariants = Object.values(variantMap).filter(
